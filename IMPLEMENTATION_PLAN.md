...
> Documento histórico de execução. O backend do MVP é **C# / ASP.NET Core 8** (ver `docs/decisions/0004-csharp-backend.md` e `AGENTS.md`). A stack Java/Spring descrita abaixo não é mais a implementação corrente.
